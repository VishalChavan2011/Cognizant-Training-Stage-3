...
namespace NamedParameter
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            obj.GetCohortDetails("Vishal Chavan", 100, Mode.OBL, Track.DOTNET, "ASP.NET");
            obj.GetCohortDetails(name: "Vishal Chavan", module: "ASP.NET", count: 100, mode: Mode.OBL, track: Track.DOTNET);
            Console.ReadLine();
        }
